...
const mergeDocumentXml = (xml, formData) => {
  ...
  [
    ...
    [31, 2, values.probationReliabilityAllowance],
    [32, 1, "Trách nhiệm , Kết quả đánh giá công việc / Responsibility monthly KPI"],
    [32, 2, values.probationKpiAllowance],
    [33, 1, "Gross Salary", { bold: true }],
    [33, 2, values.probationGrossSalary, { bold: true }],
    [34, 1, `BHXH / Social Insurance (${values.socialInsurancePct}%)`],
    [34, 2, values.probationSocialInsuranceAmount],
    [35, 1, `BHYT / Health Insurance (${values.healthInsurancePct}%)`],
    [35, 2, values.probationHealthInsuranceAmount],
    [36, 1, `BHTN / Unemployment Insurance (${values.unemploymentInsurancePct}%)`],
    [36, 2, values.probationUnemploymentInsuranceAmount],
    [37, 1, "Tổng bảo hiểm / Total Insurance", { bold: true }],
    [37, 2, values.probationTotalInsurance, { bold: true }],
    [38, 1, "Thuế TNCN / Personal Income Tax (PIT)"],
    [38, 2, values.probationPersonalIncomeTaxAmount],
    [39, 1, "Lương thực nhận / Net Salary", { bold: true }],
    [39, 2, values.probationNetSalary, { bold: true, color: "000000", align: "right" }],
    [40, 0, ""],
    [40, 1, ""],
    [40, 2, ""],
    [41, 0, ""],
  ...
  merged = removeRowsByIndex(merged, [40, 41, 42, 43, 44]);
